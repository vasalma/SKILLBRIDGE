 ...
 * @author Mi PC
 */
public class cursoMon extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cursoMon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
